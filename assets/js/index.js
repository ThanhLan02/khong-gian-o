...
const btnReviewRight = document.querySelector('.btn-review-right');
const btnReviewLeft = document.querySelector('.btn-review-left');
let currentActive = 1;
...
const countReviewItems = reviewItems.length;
console.log(currentActive);
btnReviewRight.addEventListener('click', function () {
  if (currentActive !== (countReviewItems - 1)) {
    currentActive = currentActive + 1;
    updateReview();
  }
});
btnReviewLeft.addEventListener('click', function () {
  if (currentActive !== 0) {
    currentActive = currentActive - 1;
    updateReview();
  }
...
//     updateReview(); 
// }, 3000); 
const countProjectItems = document.querySelectorAll('.project-item').length;
const lastProjectItem = document.querySelectorAll('.project-item')[document.querySelectorAll('.project-item').length - 1];
const lastProjectItemTitle = document.querySelectorAll('.project-item-tile')[document.querySelectorAll('.project-item-tile').length - 1];
window.addEventListener('load', () => {
  updateReview();
  if (countProjectItems % 2 !== 0) {
    lastProjectItem.classList.add('last-project-item');
    lastProjectItemTitle.classList.add('last-project-item-title');
  }
});
